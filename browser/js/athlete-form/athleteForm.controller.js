'use strict'
app.controller('formCtrl', function ($scope, AthleteFactory) {
	$scope.athlete = {};
	...
	$scope.submit = function(mySelectedSports){
		var selections = mySelectedSports.map(function(selection){
			return selection.Name;
		});
		$scope.athlete.sports = selections;
		AthleteFactory.create($scope.athlete)
	}
});